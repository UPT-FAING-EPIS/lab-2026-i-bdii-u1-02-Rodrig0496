...
**Estudiante:** Rodrigo Colque Quispe

## Actividades Encargadas
Para automatizar la creación de los controladores API REST solicitados, se hizo uso de la herramienta de scaffolding a través de la CLI de .NET. Las instrucciones ejecutadas en la terminal fueron las siguientes:

1. **Creación del controlador para la entidad Cliente**
...
2. **Creación del controlador para la entidad ClientesDocumento**
